...
export default function RegisterPage() {
  ...
  return (
    <main className="relative min-h-screen flex pb-25 items-center justify-center p-4 overflow-hidden bg-gradient-to-br from-red-50 via-white to-orange-50">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 text-sm mt-2">
            به خانواده‌ی Pinterest بپیوندید!
          </p>
        </div>
